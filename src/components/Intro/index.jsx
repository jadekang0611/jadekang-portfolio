      ...
      <Grid container>
        <Grid item xs={12} lg={6} className={classes.introBox}>
          ...
          <Typography variant="h1" className={classes.text1}>
            I am a seasoned frontend software engineer
          </Typography>
          <Typography variant="body2" className={classes.text2}>
            Proven track record of building high-performing and beautiful user
            interface mobile-first web applications. I strongly believe in
            continuing education and its benefits. I always seek new
            opportunities for Mid to Senior level Frontend Engineer positions
            for the right team.
          </Typography>
        </Grid>
